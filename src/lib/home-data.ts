...
export const heroSlides: HeroSlide[] = [
  {
    ...
    title: 'Precision-managed workplaces that stay safe, efficient, and future ready.',
    description:
    ...
    primaryCta: { label: 'Explore Services', href: '/services/integrated-facility-management' },
    secondaryCta: { label: 'Talk to Our Team', href: '/contact-us' },
  },
  {
    eyebrow: 'Trusted Across High-Stakes Environments',
    title: 'Operational confidence for government, healthcare, commercial, and hospitality sectors.',
    description:
    ...
    secondaryCta: { label: 'About DK Enterprise', href: '/about-us/mission-vision-purpose' },
  },
  {
    eyebrow: 'People, Process, Performance',
    title: '10,000+ professionals trained to deliver seamless service excellence at scale.',
    description:
...
export const companyStats = [
  ...
  { label: 'Countries Reached', value: 75, suffix: '+' },
  { label: 'Projects Mobilised', value: 500, suffix: '+' },
  { label: 'Professionals Deployed', value: 10000, suffix: '+' },
];
